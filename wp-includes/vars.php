...
if ( is_admin() ) {
	...
	if ( '' === $pagenow || 'index' === $pagenow || 'page-home.php' === $pagenow ) {
		$pagenow = 'page-home.php';
	} else {
		preg_match('#(.*?)(/|$)#', $pagenow, $self_matches);
		$pagenow = strtolower($self_matches[1]);
		if ( '.php' !== substr($pagenow, -4, 4) )
			$pagenow .= '.php'; // for Options +Multiviews: /wp-admin/themes/page-home.php (themes.php is queried)
	}
} else {
