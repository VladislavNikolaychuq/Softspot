...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	$permalink_structures = array(
		...
		'/page-home.php/%year%/%monthnum%/%day%/%postname%/'
	);
...
function make_site_theme_from_oldschool($theme_name, $template) {
	...
	if (! file_exists("$home_path/page-home.php"))
		return false;
	 ...
	 */
	$files = array('page-home.php' => 'page-home.php', 'wp-layout.css' => 'style.css', 'wp-comments.php' => 'comments.php', 'wp-comments-popup.php' => 'comments-popup.php');

	foreach ($files as $oldfile => $newfile) {
		if ($oldfile == 'page-home.php')
			$oldpath = $home_path;
		else
			$oldpath = ABSPATH;
		...
		if ($oldfile == 'page-home.php') {
			...
			if (strpos($index, 'WP_USE_THEMES') !== false) {
				if (! @copy(WP_CONTENT_DIR . '/themes/' . WP_DEFAULT_THEME . '/page-home.php', "$site_dir/$newfile"))
					return false;
...
function make_site_theme_from_default($theme_name, $template) {
	...
	//$files = array('page-home.php', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style.css');
