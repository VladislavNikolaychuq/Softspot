...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['page-home.php'] ) && filesize( WPMU_PLUGIN_DIR . '/page-home.php') <= 30 ) // silence is golden
		unset( $wp_plugins['page-home.php'] );
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '' ) {
	return add_submenu_page( 'page-home.php', $page_title, $menu_title, $capability, $menu_slug, $function );
}
