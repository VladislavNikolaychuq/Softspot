...
$menu[2] = array( __('Dashboard'), 'read', 'page-home.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard' );

$submenu[ 'page-home.php' ][0] = array( __('Home'), 'read', 'page-home.php' );

if ( is_multisite() ) {
	$submenu[ 'page-home.php' ][5] = array( __('My Sites'), 'read', 'my-sites.php' );
}
