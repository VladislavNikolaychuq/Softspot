...
$menu[2] = array(__('Dashboard'), 'manage_network', 'page-home.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard');

$submenu['page-home.php'][0] = array( __( 'Home' ), 'read', 'page-home.php' );
...
if ( $update_data['counts']['total'] ) {
	$submenu['page-home.php'][10] = array( sprintf( __( 'Updates %s' ), "<span class='update-plugins count-{$update_data['counts']['total']}'><span class='update-count'>" . number_format_i18n( $update_data['counts']['total'] ) . "</span></span>" ), $cap, 'update-core.php' );
} else {
	$submenu['page-home.php'][10] = array( __( 'Updates' ), $cap, 'update-core.php' );
}

unset( $cap );

$submenu['page-home.php'][15] = array( __( 'Upgrade Network' ), 'upgrade_network', 'upgrade.php' );
