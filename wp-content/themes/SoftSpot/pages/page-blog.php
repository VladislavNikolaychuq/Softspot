...
<<<<<<< Updated upstream
                    ...
                    <div id="site-header__wrap">
                        ...
                        <nav id="menu">
                            <ul>
                                <li><a href="#services" class="anchor">Pricing</a></li>
                                <li><a href="https://softspotapp.com/blog" target="_blank" rel="nofollow">Blog</a></li>
                            </ul>
                        </nav>
        ...
        <div id="site__wrap">
            ...
            <!-- page-head -->
            <div id="page-head">
                <h1 id="page-head__title">Blog</h1>
                            ...
                            <article class="blog__item">
                                ...
                                <div class="blog__item-wrap">
                                    ...
                                    <div class="blog__info">
                                        <time class="blog__date" datetime="2018-10-23">NOV 23, 2018</time>
...
Follow @softspotapp
                                    ...
                                    <a href="#" class="blog__content">
                                        ...
                                        <h2 class="blog__topic"><span>4 Arizona Dog Laws That Every Dog Owner Should Know About</span></h2>
...
>>>>>>> Stashed changes
    ...
    <div id="popup" class="is-loading">
        ...
        <div id="popup__wrap">
            ...
            <!-- popup__content -->
            <section class="popup__content popup__subscribe popup_subscribe" data-action="<?php echo admin_url( 'admin-ajax.php' );?>">
