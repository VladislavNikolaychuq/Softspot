...
?>
<div class="social">
    <a href="<?=$instagramLink?>" class="social__item">
    ...
    <a href="<?=$facebookLink?>" class="social__item">
    ...
    <a href="<?=$twitterLink?>" class="social__item">
    ...
    <a href="<?=$linkedin_link?>" class="social__item">
